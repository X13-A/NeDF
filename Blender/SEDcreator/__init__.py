...
# Register
modulesNames = ['SEDcreator', 'SEDcreator_createCluster', 'SEDcreator_utils', 'SEDcreator_setupClasses', 'SEDcreator_renderClasses', 'SEDcreator_render', 'SEDcreator_launchRender', 'SEDcreator_renderRoughness', 'SEDcreator_renderCurvature', 'SEDcreator_prepareRender', 'SEDcreator_setFocus', 'SEDcreator_saveCamerasAttributes']
